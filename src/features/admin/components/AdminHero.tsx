...
export function AdminHero() {
  return (
    <section className="relative overflow-hidden rounded-[22px] border border-line-lime bg-linear-to-br from-green-deep/95 via-bg-primary/90 to-bg-primary px-5 py-4 shadow-premium sm:rounded-[26px] sm:px-7 sm:py-5">
      <div
        aria-hidden
      ...
      <div className="relative z-[3] max-w-2xl sm:pr-44">
        ...
        <h1 className="mt-1.5 font-display text-[clamp(1.75rem,5vw,3.4rem)] leading-[0.92] tracking-[-0.04em] text-ink uppercase sm:mt-2">
          Panel <span className="text-lime">de Gestión</span>
        </h1>
        ...
        <div className="mt-3 flex flex-wrap gap-2 sm:mt-4">
          ...
          <span className="rounded-full border border-line-olive bg-green-deep/80 px-2.5 py-1.5 text-[11px] text-ink-soft sm:px-3 sm:py-2 sm:text-xs">
            📅 <b className="text-lime">Mar y jue · 19:00</b>
          </span>
        </div>
      </div>
    </section>
