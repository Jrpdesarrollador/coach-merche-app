...
| `process_auto_attendance(p_user_id)`                   | Confirma automáticamente reservas activas cuya hora de inicio + 1 h ya pasó (Europe/Madrid); sincroniza logros. No sobrescribe confirmación manual de admin                        |
